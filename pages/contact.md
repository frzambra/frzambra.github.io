...
| <th style="text-align: center"><i class="fa fa-twitter fa-2x fa-align-center"></i></th> | [@{{ site.owner.twitter }}](https://twitter.com/{{ site.owner.twitter }})  | 
| - | :- |
| <th style="text-align: center"><i class="fa fa-envelope fa-2x fa-align-center"></i></th> | Francisco Zambrano Ph.D. (c) <br>3310 Holdrege St.<br>Lincoln, NE| 
| - | :- |
